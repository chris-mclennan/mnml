...
"#
    ...
    fn marketplace_config_defaults() {
        ...
        // use_defaults is on and no user sources are set. #1055
        // added the monorepo-apps source, guarded by the render-time
        // Ready gate.
...
"#
        ...
        // #1055 added a third default source, so the user entry
        // is now at index 3.
