...
fn builtin_commands() -> Vec<Command> {
    ...
    let mut cmds = vec![
        ...
        Command {
            ...
            group: "test",
            keys: &[],
            run: |app| app.run_npm_subcommand("test"),
        },
        Command {
            id: "npm.run",
        ...
        Command {
            ...
            group: "test",
            keys: &[],
            run: |app| app.run_npm_subcommand("run build"),
        },
        Command {
            id: "npm.start",
            ...
            group: "test",
            keys: &[],
            run: |app| app.run_npm_subcommand("start"),
        },
        Command {
            id: "npm.install",
            ...
            group: "test",
            keys: &[],
            run: |app| app.run_npm_subcommand("install"),
        },
        Command {
            id: "npm.lint",
            ...
            group: "test",
            keys: &[],
            run: |app| app.run_npm_subcommand("run lint"),
        },
        Command {
            id: "pytest.run",
