...
[`mnml-libghostty-vt-sys`](../mnml-libghostty-vt-sys) bindgen crate. Covers the surface mnml
...
```toml
libghostty-vt = { package = "mnml-libghostty-vt", path = "crates/mnml-vt", version = "0.2.0" }
```
