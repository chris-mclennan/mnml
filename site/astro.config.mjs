      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Azure Blob Storage browser', slug: 'manual/integrations/fs-azure-blob' },
            ...
            { label: 'Slack browse + post', slug: 'manual/integrations/msg-slack' },
            { label: 'Microsoft Teams browse + post', slug: 'manual/integrations/msg-teams' },
            { label: 'Buttondown newsletter', slug: 'manual/integrations/msg-buttondown' },
            { label: 'Mandrill transactional email', slug: 'manual/integrations/msg-mandrill' },
            { label: 'Gmail browse + compose', slug: 'manual/integrations/msg-gmail' },
            { label: 'Google Calendar browse + create', slug: 'manual/integrations/msg-gcal' },
            { label: 'Datadog observability', slug: 'manual/integrations/obs-datadog' },
            { label: 'Cloudflare CDN', slug: 'manual/integrations/cdn-cloudflare' },
            { label: 'Docker container browser', slug: 'manual/integrations/virt-docker' },
